    ...
    <div className="mb-6">
      <Container>
        <div className="">
          ...
          {sliderModalOpen && (
            <div
              className={`fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-full bg-white z-50 max-w-[1920px]  mx-auto 2xl:px-0 lg:px-2 px-2 xl:px-4  overscroll-y-none`}
            >
